...
export default function CreateCoursePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    modules: [
      {
        title: 'Module 1',
        videos: [{ title: '', videoUrl: '', duration: 0 }]
      }
    ]
  });

  if (status === 'loading') return <div className="min-h-screen flex items-center justify-center bg-[#F9F3E7]"><div className="animate-spin rounded-full h-12 w-12 border-4 border-stone-200 border-t-amber-600"></div></div>;
    ...
    <div className="min-h-screen bg-[#F9F3E7] p-4 lg:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold text-stone-900" style={{ fontFamily: ", cursive" }}>Create New Course</h1>
        </div>
