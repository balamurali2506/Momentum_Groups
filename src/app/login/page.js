        ...
        <div className="w-full max-w-md bg-white dark:bg-[#1e1e1e] rounded-3xl border border-stone-200 dark:border-[#2d2d2d] p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/forgot-password" className="text-amber-600 dark:text-amber-400 font-semibold hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-[#1e1e1e] text-stone-500 dark:text-stone-400">Or continue with</span>
            </div>
          </div>
